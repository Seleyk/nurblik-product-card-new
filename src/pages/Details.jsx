    ...
    <div className="bg-[#F8F7F4] mb-20">
      <div className="details-container">
        ...
        <motion.div
          ...
          className="flex flex-col gap-16 max-md:w-full max-md:px-6 max-md:pt-6 max-md:bg-[#F8F7F4] max-md:bg-opacity-85 max-md:rounded-tl-3xl max-md:rounded-tr-3xl max-md:overflow-hidden max-md:bottom-1 absolute max-md:opacity-60"
        >
